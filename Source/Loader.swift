...
public class Loader: UIView {
    ...
    private var currentRotation: CGFloat = CGFloat.pi / 2
    ...
    public func startAnimating() {
        self.animationTimer = Timer.scheduledTimer(timeInterval: 0.8, target: self, selector: #selector(Loader.animateLoader), userInfo: nil, repeats: true)
    }
